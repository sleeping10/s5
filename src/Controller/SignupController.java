...
public class SignupController extends Verification implements Initializable {
    ...
    private void signUp(){
        ...
        switch (verifyAccount(tfEmail.getText(), tfPass.getText(), tfPhone.getText())) {
            ...
            case 1: DBC.getInstance().setAcc(new Account(0,tfEmail.getText(), hashedPass, tfName.getText(), tfPhone.getText(), 3));DBC.getInstance().saveAccount();lblStatus.setText("Account created");break;
